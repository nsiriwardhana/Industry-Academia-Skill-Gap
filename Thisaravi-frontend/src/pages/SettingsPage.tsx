...
import { MODEL_PROVIDERS } from '@/config/api';
import { useModelSettings, type ModelSettings } from '@/hooks/use-model-settings';
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              These settings apply to both Manual and Source modes.
            </CardDescription>
          </CardHeader>
